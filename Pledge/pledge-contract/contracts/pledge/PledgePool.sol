...
contract PledgePool is ReentrancyGuard, SafeTransfer, multiSignatureClient {
    ...
    /**
     * @dev 构造方法
     * @param _oracle 预言机，获取资产价格
     * @param _swapRouter dex交易所地址
     * @param _feeAddress 协议费
     * @param _multiSignature 多签地址
     */
    constructor(
        address _oracle,
        address _swapRouter,
     ...
     * @param _lendFee 出借款费率
     * @param _borrowFee 借款费率
     */
